...
public class Contador {
    ...
    public static void contar(int parametro, int parametro2) throws ParametrosInvalidosException {

        int contagem = parametro2 - parametro;
